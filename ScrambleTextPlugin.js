...
function C(F, C, E, e) {
    ...
    let t, n, r = [], i = F.length, s = 0;
    for (; s < i; s++) n = F.charAt(s), (n.charCodeAt(0) >= 55296 && n.charCodeAt(0) <= 56319 || F.charCodeAt(s + 1) >= 65024 && F.charCodeAt(s + 1) <= 65039) && (t = ((F.substr(s, 12).split(u) || [])[1] || "").length || 2, n = F.substr(s, t), r.emoji = 1, s += t - 1), r.push(">" === n ? "&gt;" : "<" === n ? "&lt;" : !e || " " !== n || " " !== F.charAt(s - 1) && " " !== F.charAt(s + 1) ? n : "&nbsp;");
    return r
}
...
let e, t, n = () => e || "undefined" != typeof window && (e = window.gsap) && e.registerPlugin && e, r = function () {
        return String.fromCharCode.apply(null, arguments)
    }, i = r(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), s = r(103, 115, 97, 112, 46, 99, 111, 109),
    o = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, a = function (D) {
        var u = "undefined" != typeof window,
            F = true,

            // F = 0 === (u ? window.location.href : "").indexOf(r(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(r(108, 111, 99, 97, 108, 104, 111, 115, 116)) || o.test(D) || (u ? window.location.hostname : "").split(".").pop() === r(108, 111, 99, 97, 108),
...
const g = {
    version: "3.12.5", name: "scrambleText", register(D, u, F) {
        ...
        let F, E, e, t, n, r, i, s, o, a, l, {
            ...
            original: M,
            hasClass: O
        } = u, I = h.length, P = d._time, W = P - g;
        p && (d._from && (P = d._dur - P), D = 0 === P ? 0 : P < p ? 1e-6 : P === d._dur ? 1 : d._ease((P - p) / (d._dur - p))), D < 0 ? D = 0 : D > 1 && (D = 1), L && (D = 1 - D), F = ~~(D * I + .5), D ? ((W > H || W < -H) && (u.setIndex = f = (f + (19 * Math.random() | 0)) % 20, u.chars = w.sets[f], u.prevScrambleTime += W), t = m) : t = M.join(c), l = d._from ? D : 1 - D, a = x + (v ? d._from ? l * l * l : 1 - l * l * l : 1) * T, L ? 1 !== D || !d._from && "isFromStart" !== d.data ? (i = h.slice(F).join(c), e = b ? C(t).slice(0, a - (j ? C(i) : i).length + .5 | 0).join("") : t.substr(0, a - (j ? C(i) : i).length + .5 | 0), t = i) : (e = "", t = M.join(c)) : (e = h.slice(0, F).join(c), E = (j ? C(e) : e).length, t = b ? C(t).slice(E, a + .5 | 0).join("") : t.substr(E, a - E + .5 | 0)), O ? (s = L ? y : S, o = L ? S : y, n = s && 0 !== F, r = o && F !== I, i = (n ? "<span class='" + s + "'>" : "") + e + (n ? "</span>" : "") + (r ? "<span class='" + o + "'>" : "") + c + t + (r ? "</span>" : "")) : i = e + c + t, B[A] = "&nbsp;" === _ && ~i.indexOf("  ") ? i.split("  ").join("&nbsp;&nbsp;") : i
    }
};
