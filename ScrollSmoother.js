...
class x {
    constructor(u) {
        ...
        let m, v, y, w, b, C, _, E, P, R, k, A, N, M, z, F, {
                ...
                normalizeScroll: U,
                wholePixels: q
            } = u, V = this, W = u.effectsPrefix || "", D = l.getScrollFunc(r),
            j = 1 === l.isTouch ? !0 === L ? .8 : parseFloat(L) || 0 : 0 === O || !1 === O ? 0 : parseFloat(O) || .8,
            Y = j && +u.speed || 1, K = 0, $ = 0, G = 1, J = h(0), Q = () => J.update(-K), X = {y: 0},
            ...
            }, ce = () => l.addEventListener("refresh", le), de = () => b && b.forEach(e => e.vars.onRefresh(e)),
            he = () => (b && b.forEach(e => e.vars.onRefreshInit(e)), de), fe = (e, t, r, o) => () => {
                ...
                let h, f, g, p, u, m, y = fe("speed", o, n, t), w = fe("lag", i, n, t), T = e.getProperty(t, "y"),
                    x = t._gsap, C = [], _ = () => {
        ...
        ce(), l.addEventListener("killAll", ce), e.delayedCall(.5, () => G = 0), this.scrollTop = re, this.scrollTo = (t, r, o) => {
            ...
            r ? R ? e.to(this, {duration: j, scrollTop: s, overwrite: "auto", ease: d}) : D(s) : re(s)
        }, this.offset = (t, r, o) => {
            let s, i = (t = n(t)[0]).style.cssText, a = l.create({trigger: t, start: r || "top top"});
            ...
            if (arguments.length) {
                ...
                return r !== m && (m = r, P = m.getAttribute("style") || "", oe && oe.observe(m), e.set(m, {
                    ...
                    y: "+=0"
                }), j || e.set(m, {clearProps: "transform"})), this
            }
            return m
        ...
        ue.forEach(e => e.revert(!0, !0)), w = l.create({
            ...
            let o = l.defaults({});
            o && o.scroller === v && l.defaults({scroller: r}), this.normalizer && l.normalizeScroll(!1), clearInterval(_), c = null, oe && oe.disconnect(), i.style.removeProperty("height"), r.removeEventListener("focusin", se)
        }, this.refresh = (e, t) => w.refresh(e, t), U && (this.normalizer = l.normalizeScroll(!0 === U ? {
            debounce: !0,
            content: !j && m
        } : U)), l.config(u), "overscrollBehavior" in r.getComputedStyle(i) && e.set([i, s], {overscrollBehavior: "none"}), "scrollBehavior" in r.getComputedStyle(i) && e.set([i, s], {scrollBehavior: "auto"}), r.addEventListener("focusin", se), _ = setInterval(Q, 250), "loading" === o.readyState || requestAnimationFrame(() => l.refresh())
    }
