...
let e, t, s, i, o, n = () => e || "undefined" != typeof window && (e = window.gsap) && e.registerPlugin && e,
    r = e => Math.round(1e4 * e) / 1e4, a = function () {
        return String.fromCharCode.apply(null, arguments)
    }, l = a(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), c = a(103, 115, 97, 112, 46, 99, 111, 109),
    p = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, d = (function (t) {
        var s = "undefined" != typeof window,
            i = true,
            // i = 0 === (s ? window.location.href : "").indexOf(a(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(a(108, 111, 99, 97, 108, 104, 111, 115, 116)) || p.test(t) || (s ? window.location.hostname : "").split(".").pop() === a(108, 111, 99, 97, 108),
            ...
            n = function () {
                if (s) if ("loading" === document.readyState || "interactive" === document.readyState) document.addEventListener("readystatechange", n); else {
                    document.removeEventListener("readystatechange", n);
                    var t = "object" == typeof e ? e : s && window.gsap;
                    s && window.console && !window._gsapWarned && "object" == typeof t && !1 !== t.config().trialWarn && false && (console.log(a(37, 99, 87, 97, 114, 110, 105, 110, 103), a(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)), console.log(a(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) + "PhysicsPropsPlugin" + a(32, 105, 115, 32, 108, 111, 97, 100, 101, 100, 32, 116, 104, 97, 116, 32, 111, 110, 108, 121, 32, 119, 111, 114, 107, 115, 32, 108, 111, 99, 97, 108, 108, 121, 32, 97, 110, 100, 32, 111, 110, 32, 100, 111, 109, 97, 105, 110, 115, 32, 108, 105, 107, 101, 32, 99, 111, 100, 101, 112, 101, 110, 46, 105, 111, 32, 97, 110, 100, 32, 99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111, 46, 32, 42, 42, 42, 32, 68, 79, 32, 78, 79, 84, 32, 68, 69, 80, 76, 79, 89, 32, 84, 72, 73, 83, 32, 70, 73, 76, 69, 32, 42, 42, 42, 32, 76, 111, 97, 100, 105, 110, 103, 32, 105, 116, 32, 111, 110, 32, 97, 110, 32, 117, 110, 97, 117, 116, 104, 111, 114, 105, 122, 101, 100, 32, 115, 105, 116, 101, 32, 118, 105, 111, 108, 97, 116, 101, 115, 32, 116, 104, 101, 32, 108, 105, 99, 101, 110, 115, 101, 32, 97, 110, 100, 32, 119, 105, 108, 108, 32, 99, 97, 117, 115, 101, 32, 97, 32, 114, 101, 100, 105, 114, 101, 99, 116, 46, 32, 80, 108, 101, 97, 115, 101, 32, 106, 111, 105, 110, 32, 67, 108, 117, 98, 32, 71, 114, 101, 101, 110, 83, 111, 99, 107, 32, 116, 111, 32, 103, 101, 116, 32, 102, 117, 108, 108, 32, 97, 99, 99, 101, 115, 115, 32, 116, 111, 32, 116, 104, 101, 32, 98, 111, 110, 117, 115, 32, 112, 108, 117, 103, 105, 110, 115, 32, 116, 104, 97, 116, 32, 98, 111, 111, 115, 116, 32, 121, 111, 117, 114, 32, 97, 110, 105, 109, 97, 116, 105, 111, 110, 32, 115, 117, 112, 101, 114, 112, 111, 119, 101, 114, 115, 46, 32, 68, 105, 115, 97, 98, 108, 101, 32, 116, 104, 105, 115, 32, 119, 97, 114, 110, 105, 110, 103, 32, 119, 105, 116, 104, 32, 103, 115, 97, 112, 46, 99, 111, 110, 102, 105, 103, 40, 123, 116, 114, 105, 97, 108, 87, 97, 114, 110, 58, 32, 102, 97, 108, 115, 101, 125, 41, 59)), console.log(a(37, 99, 71, 101, 116, 32, 117, 110, 114, 101, 115, 116, 114, 105, 99, 116, 101, 100, 32, 102, 105, 108, 101, 115, 32, 97, 116, 32, 104, 116, 116, 112, 115, 58, 47, 47, 103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109, 47, 99, 108, 117, 98), a(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)), window._gsapWarned = 1)
                }
            }, r = o.length;
        for (setTimeout(n, 50); --r > -1;) if (-1 !== t.indexOf(o[r])) return !0;
        i || setTimeout((function () {}), 4e3)
    }("undefined" != typeof window ? window.location.host : ""), r => {
        e = r || n(), t || (s = e.utils.getUnit, i = e.core.getStyleSaver, o = e.core.reverting || function () {
        }, t = 1)
    });

class f {
    constructor(e, t, i, o, n, r) {
        let a = e._gsap, l = a.get(e, t);
        this.p = t, this.set = a.set(e, t), this.s = this.val = parseFloat(l), this.u = s(l) || 0, this.vel = i || 0, this.v = this.vel / r, o || 0 === o ? (this.acc = o, this.a = this.acc / (r * r)) : this.acc = this.a = 0, this.fr = 1 - (n || 0)
    }
}

const h = {
    version: "3.12.5", name: "physicsProps", register: d, init(e, s, o) {
        t || d();
        let n, r = this;
        for (n in r.styles = i && i(e), r.target = e, r.tween = o, r.step = 0, r.sps = 30, r.vProps = [], s) {
            let {velocity: t, acceleration: o, friction: a} = s[n];
            (t || o) && (r.vProps.push(new f(e, n, t, o, a, r.sps)), r._props.push(n), i && r.styles.save(n), a && (r.hasFr = 1))
        }
    }, render(e, t) {
        let s, i, n, a, l, {vProps: c, tween: p, target: d, step: f, hasFr: h, sps: u} = t, g = c.length,
        ...
        if (p._time || !o()) if (h) {
            ...
            for (n = v % 1; g--;) {
                for (s = c[g], a = i; a--;) s.v += s.a, s.v *= s.fr, s.val += s.v;
                s.set(d, s.p, r(s.val + s.v * n * s.fr) + s.u)
            }
            t.step += i
        } else for (l = v * v * .5; g--;) s = c[g], s.set(d, s.p, r(s.s + s.vel * v + s.acc * l) + s.u); else t.styles.revert()
    }, kill(e) {
        let t = this.vProps, s = t.length;
