...
let u, e, t, F, C, i, n = /(?:\r|\n|\t\t)/g, s = /(?:\s\s+)/g, E = String.fromCharCode(160), l = D => {
    ...
    a = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, p = function (D) {
        var u = "undefined" != typeof window,
            e = true,
            // e = 0 === (u ? window.location.href : "").indexOf(o(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(o(108, 111, 99, 97, 108, 104, 111, 115, 116)) || a.test(D) || (u ? window.location.hostname : "").split(".").pop() === o(108, 111, 99, 97, 108),
