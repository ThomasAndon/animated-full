...
let e, t, n, o = () => e || "undefined" != typeof window && (e = window.gsap) && e.registerPlugin && e, i = {
        ...
        if (!t) if (e = o(), n = e && e.parseEase("_CE"), n) {
            for (let e in i) i[e] = n("", i[e]);
            t = 1, f("wiggle").config = e => "object" == typeof e ? f("", e) : f("wiggle(" + e + ")", {wiggles: +e})
        } else a && console.warn("Please gsap.registerPlugin(CustomEase, CustomWiggle)")
    }, r = (t, o) => ("function" != typeof t && (t = e.parseEase(t) || n("", t)), t.custom || !o ? t : e => 1 - t(e)),
    l = function () {
        return String.fromCharCode.apply(null, arguments)
    }, u = l(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), g = l(103, 115, 97, 112, 46, 99, 111, 109),
    d = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, c = function (t) {
        var n = "undefined" != typeof window,
            o = true,
            // o = 0 === (n ? window.location.href : "").indexOf(l(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(l(108, 111, 99, 97, 108, 104, 111, 115, 116)) || d.test(t) || (n ? window.location.hostname : "").split(".").pop() === l(108, 111, 99, 97, 108),
        ...
        if (c) {
            if (M && (O = v, v = i.easeOut), o.timingEase && (O = r(o.timingEase)), o.amplitudeEase && (v = r(o.amplitudeEase, !0)), p = O(E), w = M ? -v(E) : v(E), h = [0, 0, p / 4, 0, p / 2, w, p, w], "random" === o.type) {
                for (h.length = 4, l = O(C), u = 2 * Math.random() - 1, m = 2; m < y; m++) E = l, w = u, l = O(C * m), u = 2 * Math.random() - 1, g = Math.atan2(u - h[h.length - 3], l - h[h.length - 4]), d = Math.cos(g) * C, f = Math.sin(g) * C, h.push(E - d, w - f, E, w, E + d, w + f);
                h.push(l, 0, 1, 0)
            } else {
                for (m = 1; m < y; m++) h.push(O(E + C / 2), w), E += C, w = (w > 0 ? -1 : 1) * v(m * C), p = O(E), h.push(O(E - C / 2), w, p, w);
