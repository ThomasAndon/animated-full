...
!function (e, t) {
    ...
    function r(e) {
        a = e || i(), l || (c = a.utils.getUnit, d = a.core.getStyleSaver, h = a.core.reverting || function () {
        }, l = 1)
    }

    function s(e, t, n, i, o, s) {
        var r = e._gsap, a = r.get(e, t);
    ...
    var a, l, c, d, h, f = "PhysicsPropsPlugin", u = m(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        p = m(103, 115, 97, 112, 46, 99, 111, 109), v = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, t = (function (e) {
            var t = "undefined" != typeof window,
                n = true,
                // n = 0 === (t ? window.location.href : "").indexOf(m(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(m(108, 111, 99, 97, 108, 104, 111, 115, 116)) || v.test(e) || (t ? window.location.hostname : "").split(".").pop() === m(108, 111, 99, 97, 108),
            ...
            init: function init(e, t, n) {
                ...
                for (i in o.styles = d && d(e), o.target = e, o.tween = n, o.step = 0, o.sps = 30, o.vProps = [], t) {
                    var a = t[i], c = a.velocity, m = a.acceleration, f = a.friction;
                    (c || m) && (o.vProps.push(new s(e, i, c, m, f, o.sps)), o._props.push(i), d && o.styles.save(i), f && (o.hasFr = 1))
                }
            },
            render: function render(e, t) {
                var n, i, o, s, r, a = t.vProps, c = t.tween, m = t.target, f = t.step, l = t.hasFr, d = t.sps,
                    u = a.length, p = c._from ? c._dur - c._time : c._time;
                if (c._time || !h()) if (l) {
                    if ((i = (0 | (p *= d)) - f) < 0) {
                    ...
                    t.step += i
                } else for (r = p * p * .5; u--;) (n = a[u]).set(m, n.p, j(n.s + n.vel * p + n.acc * r) + n.u); else t.styles.revert()
            },
