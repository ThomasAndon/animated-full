...
!function (t, e) {
    ...
    var n, l, g, o, a, s, i, c, f = {}, d = {deg: 360, rad: 2 * Math.PI}, h = function () {
    ...
    function ca(t) {
        var e, n, i = {};
        for (e in t) i[e] = O(n = t[e]) && !D(n) ? ca(n) : n;
        return i
    }
    ...
    function ea(t, e, n, i, r, o, a) {
        ...
        if (n = isNaN(n) ? $ : n, i = isNaN(i) ? -$ : i, O(e)) {
            if (s = e.calculated ? e : (P(u) ? u(e, a) : da(e, u, n, i, o)) || e, !e.calculated) {
                for (c in s) e[c] = s[c];
                e.calculated = !0
            }
            s = s[r]
        } else s = P(u) ? u(e, a) : D(u) ? da(e, u, n, i, o) : parseFloat(u);
    ...
    function ja(t, e, n, i) {
        if (e.linkedProps) {
            var r, o, a, s, c, u, f = e.linkedProps.split(","), l = {};
            for (r = 0; r < f.length; r++) (a = e[o = f[r]]) && (s = N(a.velocity) ? a.velocity : (c = c || C(t)) && c.isTracking(o) ? c.get(o) : 0, u = Math.abs(s / fa(a, "resistance", i)), l[o] = parseFloat(n(t, o)) + ga(s, u));
            return l
        }
    }
    ...
    var v, _, y, T, w, x, b, F, V, k, j, M, A, E, C = h.getByTarget, W = "InertiaPlugin",
        I = S(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), B = S(103, 115, 97, 112, 46, 99, 111, 109),
        R = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, U = function (t) {
            var e = "undefined" != typeof window,
                n = true,
                // n = 0 === (e ? window.location.href : "").indexOf(S(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(S(108, 111, 99, 97, 108, 104, 111, 115, 116)) || R.test(t) || (e ? window.location.hostname : "").split(".").pop() === S(108, 111, 99, 97, 108),
