...
!function (n, e) {
    ...
    function s(n) {
        r = n || j(), f || (a = r.utils.getUnit, u = r.core.getStyleSaver, y = r.core.reverting || function () {
        }, f = 1)
    }

    function t(n, e, t, i, o) {
        var s = n._gsap, r = s.get(n, e);
        this.p = e, this.set = s.set(n, e), this.s = this.val = parseFloat(r), this.u = a(r) || 0, this.vel = t || 0, this.v = this.vel / o, i || 0 === i ? (this.acc = i, this.a = this.acc / (o * o)) : this.acc = this.a = 0
    }

    var r, f, a, u, y, v = Math.PI / 180, c = "Physics2DPlugin",
        l = n(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), p = n(103, 115, 97, 112, 46, 99, 111, 109),
        d = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, i = (function (e) {
            var t = "undefined" != typeof window,
                i = true,
                // i = 0 === (t ? window.location.href : "").indexOf(n(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(n(108, 111, 99, 97, 108, 104, 111, 115, 116)) || d.test(e) || (t ? window.location.hostname : "").split(".").pop() === n(108, 111, 99, 97, 108),
            ...
            }, 50); -1 < --s;) if (-1 !== e.indexOf(o[s])) return;
            i || setTimeout(function () {}, 4e3)
        }("undefined" != typeof window ? window.location.host : ""), {
            version: "3.12.5", name: "physics2D", register: s, init: function init(n, e, i) {
                f || s();
                var o = this, r = +e.angle || 0, a = +e.velocity || 0, c = +e.acceleration || 0, l = e.xProp || "x",
                    p = e.yProp || "y", d = e.accelerationAngle || 0 === e.accelerationAngle ? +e.accelerationAngle : r;
                o.styles = u && u(n, e.xProp && "x" !== e.xProp ? e.xProp + "," + e.yProp : "transform"), o.target = n, o.tween = i, o.step = 0, o.sps = 30, e.gravity && (c = +e.gravity, d = 90), r *= v, d *= v, o.fr = 1 - (+e.friction || 0), o._props.push(l, p), o.xp = new t(n, l, Math.cos(r) * a, Math.cos(d) * c, o.sps), o.yp = new t(n, p, Math.sin(r) * a, Math.sin(d) * c, o.sps), o.skipX = o.skipY = 0
            }, render: function render(n, e) {
                var t, i, o, s, r, a, c = e.xp, l = e.yp, p = e.tween, d = e.target, f = e.step, u = e.sps, v = e.fr,
                    h = e.skipX, g = e.skipY, w = p._from ? p._dur - p._time : p._time;
                if (p._time || !y()) {
                    if (1 === v) o = w * w * .5, t = c.s + c.vel * w + c.acc * o, i = l.s + l.vel * w + l.acc * o; else {
                        for (s = a = (0 | (w *= u)) - f, a < 0 && (c.v = c.vel / u, l.v = l.vel / u, c.val = c.s, l.val = l.s, s = a = (e.step = 0) | w), r = w % 1 * v; a--;) c.v += c.a, l.v += l.a, c.v *= v, l.v *= v, c.val += c.v, l.val += l.v;
                        t = c.val + c.v * r, i = l.val + l.v * r, e.step += s
                    }
                    h || c.set(d, c.p, k(t) + c.u), g || l.set(d, l.p, k(i) + l.u)
