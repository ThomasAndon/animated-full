...
!function (e, n) {
    ...
    var r, b, j, u = "CustomBounce", s = l(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        a = l(103, 115, 97, 112, 46, 99, 111, 109), c = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, B = function (e) {
            var n = "undefined" != typeof window,
                t = true,
                // t = 0 === (n ? window.location.href : "").indexOf(l(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(l(108, 111, 99, 97, 108, 104, 111, 115, 116)) || c.test(e) || (n ? window.location.hostname : "").split(".").pop() === l(108, 111, 99, 97, 108),
            ...
            for (setTimeout(function checkWarn() {
                if (n) if ("loading" === document.readyState || "interactive" === document.readyState) document.addEventListener("readystatechange", checkWarn); else {
                    document.removeEventListener("readystatechange", checkWarn);
                    var e = "object" == typeof r ? r : n && window.gsap;
                    n && window.console && !window._gsapWarned && "object" == typeof e && !1 !== e.config().trialWarn && false && (console.log(l(37, 99, 87, 97, 114, 110, 105, 110, 103), l(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)), console.log(l(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) + u + l(32, 105, 115, 32, 108, 111, 97, 100, 101, 100, 32, 116, 104, 97, 116, 32, 111, 110, 108, 121, 32, 119, 111, 114, 107, 115, 32, 108, 111, 99, 97, 108, 108, 121, 32, 97, 110, 100, 32, 111, 110, 32, 100, 111, 109, 97, 105, 110, 115, 32, 108, 105, 107, 101, 32, 99, 111, 100, 101, 112, 101, 110, 46, 105, 111, 32, 97, 110, 100, 32, 99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111, 46, 32, 42, 42, 42, 32, 68, 79, 32, 78, 79, 84, 32, 68, 69, 80, 76, 79, 89, 32, 84, 72, 73, 83, 32, 70, 73, 76, 69, 32, 42, 42, 42, 32, 76, 111, 97, 100, 105, 110, 103, 32, 105, 116, 32, 111, 110, 32, 97, 110, 32, 117, 110, 97, 117, 116, 104, 111, 114, 105, 122, 101, 100, 32, 115, 105, 116, 101, 32, 118, 105, 111, 108, 97, 116, 101, 115, 32, 116, 104, 101, 32, 108, 105, 99, 101, 110, 115, 101, 32, 97, 110, 100, 32, 119, 105, 108, 108, 32, 99, 97, 117, 115, 101, 32, 97, 32, 114, 101, 100, 105, 114, 101, 99, 116, 46, 32, 80, 108, 101, 97, 115, 101, 32, 106, 111, 105, 110, 32, 67, 108, 117, 98, 32, 71, 114, 101, 101, 110, 83, 111, 99, 107, 32, 116, 111, 32, 103, 101, 116, 32, 102, 117, 108, 108, 32, 97, 99, 99, 101, 115, 115, 32, 116, 111, 32, 116, 104, 101, 32, 98, 111, 110, 117, 115, 32, 112, 108, 117, 103, 105, 110, 115, 32, 116, 104, 97, 116, 32, 98, 111, 111, 115, 116, 32, 121, 111, 117, 114, 32, 97, 110, 105, 109, 97, 116, 105, 111, 110, 32, 115, 117, 112, 101, 114, 112, 111, 119, 101, 114, 115, 46, 32, 68, 105, 115, 97, 98, 108, 101, 32, 116, 104, 105, 115, 32, 119, 97, 114, 110, 105, 110, 103, 32, 119, 105, 116, 104, 32, 103, 115, 97, 112, 46, 99, 111, 110, 102, 105, 103, 40, 123, 116, 114, 105, 97, 108, 87, 97, 114, 110, 58, 32, 102, 97, 108, 115, 101, 125, 41, 59)), console.log(l(37, 99, 71, 101, 116, 32, 117, 110, 114, 101, 115, 116, 114, 105, 99, 116, 101, 100, 32, 102, 105, 108, 101, 115, 32, 97, 116, 32, 104, 116, 116, 112, 115, 58, 47, 47, 103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109, 47, 99, 108, 117, 98), l(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)), window._gsapWarned = 1)
                }
            }, 50); -1 < --i;) if (-1 !== e.indexOf(o[i])) return !0;
            return t || !setTimeout(function () {}, 4e3)
        }("undefined" != typeof window ? window.location.host : ""), t = function _create(e, n) {
            if (b || h(1), n = n || {}, B) {
                var t, o, l, r, u, s, a, c = Math.min(.999, n.strength || .7), f = c, d = (n.squash || 0) / 100, g = d,
                    p = 1 / .03, w = .2, m = 1, y = .1, C = [0, 0, .07, 0, .1, 1, .1, 1], v = [0, 0, 0, 0, .1, 0, .1, 0];
                for (u = 0; u < 200 && (s = y + (w *= f * ((f + 1) / 2)), r = 1 - (m *= c * c), o = (l = y + .49 * w) + .8 * (l - (t = y + m / p)), d && (y += d, t += d, l += d, o += d, s += d, a = d / g, v.push(y - d, 0, y - d, a, y - d / 2, a, y, a, y, 0, y, 0, y, -.6 * a, y + (s - y) / 6, 0, s, 0), C.push(y - d, 1, y, 1, y, 1), d *= c * c), C.push(y, 1, t, r, l, r, o, r, s, 1, s, 1), c *= .95, p = m / (s - o), y = s, !(.999 < r)); u++) ;
                if (n.endAtStart && "false" !== n.endAtStart) {
                    if (l = -.1, C.unshift(l, 1, l, 1, -.07, 0), g) for (l -= d = 2.5 * g, C.unshift(l, 1, l, 1, l, 1), v.splice(0, 6), v.unshift(l, 0, l, 0, l, 1, l + d / 2, 1, l + d, 1, l + d, 0, l + d, 0, l + d, -.6, l + d + .033, 0), u = 0; u < v.length; u += 2) v[u] -= l;
                    for (u = 0; u < C.length; u += 2) C[u] -= l, C[u + 1] = 1 - C[u + 1]
                }
                return d && (i(v), v[2] = "C" + v[2], j(n.squashID || e + "-squash", "M" + v.join(","))), i(C), C[2] = "C" + C[2], j(e, "M" + C.join(","))
            }
        }, n = (CustomBounce.create = function create(e, n) {
            return t(e, n)
    ...
    g() && r.registerPlugin(n), n.version = "3.12.5", e.CustomBounce = n, e.default = n;
