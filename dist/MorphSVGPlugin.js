...
!function (t, e) {
    ...
    function convertToPath(t, e) {
        var n, r, o, a, i, s, h, l, c, g, p, f, u, d, P, m, w, _, v, y, x, M, T = t.tagName.toLowerCase(),
            b = .552284749831;
    ...
    function arcToSegment(t, e, n, r, o, a, i, s, h) {
        if (t !== s || e !== h) {
            ...
            var l = o % 360 * E, c = B(l), g = H(l), p = Math.PI, f = 2 * p, u = (t - s) / 2, d = (e - h) / 2,
                P = c * u + g * d, m = -g * u + c * d, w = P * P, _ = m * m, v = w / (n * n) + _ / (r * r);
            1 < v && (n = Q(v) * n, r = Q(v) * r);
            var y = n * n, x = r * r, M = (y * x - y * _ - x * w) / (y * _ + x * w);
            M < 0 && (M = 0);
    ...
    function stringToRawPath(t) {
        ...
        }).match(T) || [], m = [], w = 0, _ = 0, v = P.length, y = 0, x = "ERROR: malformed path: " + t;
        if (!t || !isNaN(P[0]) || isNaN(P[1])) return console.log(x), m;
        for (e = 0; e < v; e++) if (f = a, isNaN(P[e]) ? i = (a = P[e].toUpperCase()) !== P[e] : e--, r = +P[e + 1], o = +P[e + 2], i && (r += w, o += _), e || (h = r, l = o), "M" === a) s && (s.length < 8 ? --m.length : y += s.length), w = h = r, _ = l = o, s = [r, o], m.push(s), e += 2, a = "L"; else if ("C" === a) i || (w = _ = 0), (s = s || [0, 0]).push(r, o, w + 1 * P[e + 3], _ + 1 * P[e + 4], w += 1 * P[e + 5], _ += 1 * P[e + 6]), e += 6; else if ("S" === a) c = w, g = _, "C" !== f && "S" !== f || (c += w - s[s.length - 4], g += _ - s[s.length - 3]), i || (w = _ = 0), s.push(c, g, r, o, w += 1 * P[e + 3], _ += 1 * P[e + 4]), e += 4; else if ("Q" === a) c = w + 2 / 3 * (r - w), g = _ + 2 / 3 * (o - _), i || (w = _ = 0), w += 1 * P[e + 3], _ += 1 * P[e + 4], s.push(c, g, w + 2 / 3 * (r - w), _ + 2 / 3 * (o - _), w, _), e += 4; else if ("T" === a) c = w - s[s.length - 4], g = _ - s[s.length - 3], s.push(w + c, _ + g, r + 2 / 3 * (w + 1.5 * c - r), o + 2 / 3 * (_ + 1.5 * g - o), w = r, _ = o), e += 2; else if ("H" === a) Ac(w, _, w = r, _), e += 1; else if ("V" === a) Ac(w, _, w, _ = r + (i ? _ - w : 0)), e += 1; else if ("L" === a || "Z" === a) "Z" === a && (r = h, o = l, s.closed = !0), ("L" === a || .5 < D(w - r) || .5 < D(_ - o)) && (Ac(w, _, r, o), "L" === a && (e += 2)), w = r, _ = o; else if ("A" === a) {
            if (u = P[e + 4], d = P[e + 5], c = P[e + 6], g = P[e + 7], n = 7, 1 < u.length && (u.length < 3 ? (g = c, c = d, n--) : (g = d, c = u.substr(2), n -= 2), d = u.charAt(1), u = u.charAt(0)), p = arcToSegment(w, _, +P[e + 1], +P[e + 2], +P[e + 3], +u, +d, (i ? w : 0) + 1 * c, (i ? _ : 0) + 1 * g), e += n, p) for (n = 0; n < p.length; n++) s.push(p[n]);
            w = s[s.length - 2], _ = s[s.length - 1]
        } else console.log(x);
    ...
    function W(t, e) {
        void 0 === e && (e = 3);
        for (var n, r, o, a, i, s, h, l, c, g, p, f, u, d, P, m, w = t.length, _ = t[0][0], v = _, y = t[0][1], x = y, M = 1 / e; -1 < --w;) for (n = (i = t[w]).length, a = 6; a < n; a += 6) for (c = i[a], g = i[a + 1], p = i[a + 2] - c, d = i[a + 3] - g, f = i[a + 4] - c, P = i[a + 5] - g, u = i[a + 6] - c, m = i[a + 7] - g, s = e; -1 < --s;) _ < (r = ((h = M * s) * h * u + 3 * (l = 1 - h) * (h * f + l * p)) * h + c) ? _ = r : r < v && (v = r), y < (o = (h * h * m + 3 * l * (h * P + l * d)) * h + g) ? y = o : o < x && (x = o);
        return t.centerX = (_ + v) / 2, t.centerY = (y + x) / 2, t.left = v, t.width = _ - v, t.top = x, t.height = y - x, t.size = (_ - v) * (y - x)
    }
    ...
    function $(t, e, n, r, o) {
        ...
        for (n *= 6, i = 0; i < l; i += 6) h = t[a = (i + n) % g] - (e[i] - r), s = t[1 + a] - (e[i + 1] - o), c += w(s * s + h * h);
        return c
    }
    ...
    function aa(t, e, n) {
        for (var r, o, a, i, s, h, l = t.length, c = 1e20, g = 0, p = 0; -1 < --l;) for (h = (r = t[l]).length, s = 0; s < h; s += 6) o = r[s] - e, a = r[s + 1] - n, (i = w(o * o + a * a)) < c && (c = i, g = r[s], p = r[s + 1]);
        return [g, p]
    }
    ...
    function ba(t, e, n, r, o, a) {
        ...
        for (i = n; i < c && !((e[i].size || V(e[i])) < p); i++) s = e[i].centerX - u, h = e[i].centerY - d, (l = w(s * s + h * h)) < f && (g = i, f = l);
        return l = e[g], e.splice(g, 1), l
    }

    function ca(t, e) {
        var n, r, o, a, i, s, h, l, c, g, p, f, u, d, P = 0, m = t.length, w = e / ((m - 2) / 6);
        for (u = 2; u < m; u += 6) for (P += w; .999999 < P;) n = t[u - 2], r = t[u - 1], o = t[u], a = t[u + 1], i = t[u + 2], s = t[u + 3], h = t[u + 4], l = t[u + 5], c = n + (o - n) * (d = 1 / ((Math.floor(P) || 1) + 1)), c += ((p = o + (i - o) * d) - c) * d, p += (i + (h - i) * d - p) * d, g = r + (a - r) * d, g += ((f = a + (s - a) * d) - g) * d, f += (s + (l - s) * d - f) * d, t.splice(u, 4, n + (o - n) * d, r + (a - r) * d, c, g, c + (p - c) * d, g + (f - g) * d, p, f, i + (h - i) * d, s + (l - s) * d), u += 6, m += 6, P--;
        return t
    }

    function da(t, e, n, r, o) {
        var a, i, s, h, l, c, g, p = e.length - t.length, f = 0 < p ? e : t, u = 0 < p ? t : e, d = 0,
            P = "complexity" === r ? X : Y, m = "position" === r ? 0 : "number" == typeof r ? r : .8, w = u.length,
            v = "object" == typeof n && n.push ? n.slice(0) : [n], y = "reverse" === v[0] || v[0] < 0, x = "log" === n;
        if (u[0]) {
            if (1 < f.length && (t.sort(P), e.sort(P), f.size || W(f), u.size || W(u), c = f.centerX - u.centerX, g = f.centerY - u.centerY, P === Y)) for (w = 0; w < u.length; w++) f.splice(w, 0, ba(u[w], f, w, m, c, g));
            if (p) for (p < 0 && (p = -p), f[0].length > u[0].length && ca(u[0], (f[0].length - u[0].length) / 6 | 0), w = u.length; d < p;) f[w].size || V(f[w]), h = (s = aa(u, f[w].centerX, f[w].centerY))[0], l = s[1], u[w++] = [h, l, h, l, h, l, h, l], u.totalPoints += 8, d++;
            for (w = 0; w < t.length; w++) a = e[w], i = t[w], (p = a.length - i.length) < 0 ? ca(a, -p / 6 | 0) : 0 < p && ca(i, p / 6 | 0), y && !1 !== o && !i.reversed && reverseSegment(i), (n = v[w] || 0 === v[w] ? v[w] : "auto") && (i.closed || Math.abs(i[0] - i[i.length - 2]) < .5 && Math.abs(i[1] - i[i.length - 1]) < .5 ? "auto" === n || "log" === n ? (v[w] = n = _(i, a, !w || !1 === o), n < 0 && (y = !0, reverseSegment(i), n = -n), Z(i, 6 * n)) : "reverse" !== n && (w && n < 0 && reverseSegment(i), Z(i, 6 * (n < 0 ? -n : n))) : !y && ("auto" === n && Math.abs(a[0] - i[0]) + Math.abs(a[1] - i[1]) + Math.abs(a[a.length - 2] - i[i.length - 2]) + Math.abs(a[a.length - 1] - i[i.length - 1]) > Math.abs(a[0] - i[i.length - 2]) + Math.abs(a[1] - i[i.length - 1]) + Math.abs(a[a.length - 2] - i[0]) + Math.abs(a[a.length - 1] - i[1]) || n % 2) ? (reverseSegment(i), v[w] = -1, y = !0) : "auto" === n ? v[w] = 0 : "reverse" === n && (v[w] = -1), i.closed !== a.closed && (i.closed = a.closed = !1));
    ...
    function ka(t, e) {
        for (var n, r, o, a, i, s, h, l, c, g, p, f, u = t.length, d = .2 * (e || 1); -1 < --u;) {
            for (p = (r = t[u]).isSmooth = r.isSmooth || [0, 0, 0, 0], f = r.smoothData = r.smoothData || [0, 0, 0, 0], p.length = 4, l = r.length - 2, h = 6; h < l; h += 6) o = r[h] - r[h - 2], a = r[h + 1] - r[h - 1], i = r[h + 2] - r[h], s = r[h + 3] - r[h + 1], c = v(a, o), g = v(s, i), (n = Math.abs(c - g) < d) && (f[h - 2] = c, f[h + 2] = g, f[h - 1] = w(o * o + a * a), f[h + 3] = w(i * i + s * s)), p.push(n, n, 0, 0, n, n);
            r[l] === r[0] && r[1 + l] === r[1] && (o = r[0] - r[l - 2], a = r[1] - r[l - 1], i = r[2] - r[0], s = r[3] - r[1], c = v(a, o), g = v(s, i), Math.abs(c - g) < d && (f[l - 2] = c, f[2] = g, f[l - 1] = w(o * o + a * a), f[3] = w(i * i + s * s), p[l - 2] = p[l - 1] = !0))
        }
        return t
    }
    ...
    function oa(t, e, n, r) {
        var o, a, i = this._origin, s = this._eOrigin, h = t[n] - i.x, l = t[n + 1] - i.y, c = w(h * h + l * l),
            g = v(l, h);
        return h = e[n] - s.x, l = e[n + 1] - s.y, a = function _shortAngle(t) {
            return t !== t % p ? t + (t < 0 ? f : -f) : t
        }(o = v(l, h) - g), !r && j && Math.abs(a + j.ca) < u && (r = j), this._anchorPT = j = {
    ...
    var a, C, j, I, n, v = Math.atan2, x = Math.cos, A = Math.sin, w = Math.sqrt, p = Math.PI, f = 2 * p, u = .3 * p,
        ...
        c = P(103, 115, 97, 112, 46, 99, 111, 109), g = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, k = function (t) {
            var e = "undefined" != typeof window,
                n = true,
                // n = 0 === (e ? window.location.href : "").indexOf(P(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(P(108, 111, 99, 97, 108, 104, 111, 115, 116)) || g.test(t) || (e ? window.location.hostname : "").split(".").pop() === P(108, 111, 99, 97, 108),
        ...
        q = "Use MorphSVGPlugin.convertToPath() to convert to a path before morphing.", J = {
            ...
            init: function init(t, e, n, r, o) {
                ...
                var a, i, s, h, l, c, g, p, f, u, d, P, m, w, _, v, y, x, T, b, S, N;
                ...
                if (c = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", g = e.map || J.defaultMap, this._prop = e.prop, this._render = e.render || J.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : J.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, h) {
                    if (this._target = t, y = "object" == typeof e.precompile, u = this._prop ? t[this._prop] : t.getAttribute(i), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", u), "d" === i || this._prop) {
                        ...
                        for ("log" !== e.precompile && !0 !== e.precompile || M('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || J.defaultType)) && (u = ka(u, e.smoothTolerance), d = ka(d, e.smoothTolerance), u.size || W(u), d.size || W(d), b = la(O[0]), this._origin = u.origin = {
                        ...
                        }), this._rawPath = t._gsRawPath = u, m = u.length; -1 < --m;) for (_ = u[m], v = d[m], p = _.isSmooth || [], f = v.isSmooth || [], w = _.length, P = j = 0; P < w; P += 2) v[P] === _[P] && v[P + 1] === _[P + 1] || (S ? p[P] && f[P] ? (x = _.smoothData, T = v.smoothData, N = P + (P === w - 4 ? 7 - w : 5), this._controlPT = {
                            ...
                            l2s: x[N],
                            l2c: T[N] - x[N]
                        }, s = this._tweenRotation(_, v, P + 2), this._tweenRotation(_, v, P, s), this._tweenRotation(_, v, N - 1, s), P += 4) : this._tweenRotation(_, v, P) : (s = this.add(_, P, _[P], v[P], 0, 0, 0, 0, 0, 1), s = this.add(_, P + 1, _[P + 1], v[P + 1], 0, 0, 0, 0, 0, 1) || s))
            ...
            render: function render(t, e) {
                for (var n, r, o, a, i, s, h, l, c, g, p, f, u = e._rawPath, d = e._controlPT, P = e._anchorPT, m = e._rnd, w = e._target, _ = e._pt; _;) _.r(t, _.d), _ = _._next;
                if (1 === t && e._apply) for (_ = e._pt; _;) _.end && (e._prop ? w[e._prop] = _.end : w.setAttribute(_.endProp, _.end)), _ = _._next; else if (u) {
                    for (; P;) i = P.sa + t * P.ca, a = P.sl + t * P.cl, P.t[P.i] = e._origin.x + x(i) * a, P.t[P.i + 1] = e._origin.y + A(i) * a, P = P._next;
                    for (r = t < .5 ? 2 * t * t : (4 - 2 * t) * t - 1; d;) f = (s = d.i) + (s === (o = u[d.j]).length - 4 ? 7 - o.length : 5), i = v(o[f] - o[s + 1], o[f - 1] - o[s]), g = A(i), p = x(i), l = o[s + 2], c = o[s + 3], a = d.l1s + r * d.l1c, o[s] = l - p * a, o[s + 1] = c - g * a, a = d.l2s + r * d.l2c, o[f - 1] = l + p * a, o[f] = c + g * a, d = d._next;
