...
!function (D, u) {
    ...
    function n(D) {
        U = document, e = window, (i = i || D || e.gsap || console.warn("Please gsap.registerPlugin(SplitText)")) && (o = i.utils.toArray, s = i.core.context || function () {
        }, t = 1)
    }
    ...
    function A(D, u, e) {
        var t = D.nodeType;
        if (1 === t || 9 === t || 11 === t) for (D = D.firstChild; D; D = D.nextSibling) A(D, u, e); else 3 !== t && 4 !== t || (D.nodeValue = D.nodeValue.split(u).join(e))
    }
    ...
    function D(u) {
        var e, t, F = o(u.childNodes), i = F.length;
    ...
    function F(u, e, t, F, i, n, s) {
        var o, r, l, d, a, p, h, f, c, g, x, y, b = v(u), S = E("paddingLeft", b), _ = -999,
            m = E("borderBottomWidth", b) + E("borderTopWidth", b),
            q = E("borderLeftWidth", b) + E("borderRightWidth", b), T = E("paddingTop", b) + E("paddingBottom", b),
            N = E("paddingLeft", b) + E("paddingRight", b), L = E("fontSize", b) * (e.lineThreshold || .2),
            W = b.textAlign, H = [], O = [], j = [], k = e.wordDelimiter || " ",
            V = e.tag ? e.tag : e.span ? "span" : "div", M = e.type || e.split || "chars,words,lines",
            R = i && ~M.indexOf("lines") ? [] : null, P = ~M.indexOf("words"), z = ~M.indexOf("chars"), G = w(e),
            $ = e.linesClass, I = ~($ || "").indexOf("++"), J = [], K = "flex" === b.display, Q = u.style.display;
        for (I && ($ = $.split("++").join("")), K && (u.style.display = "block"), l = (r = u.getElementsByTagName("*")).length, a = [], o = 0; o < l; o++) a[o] = r[o];
        if (R || G) for (o = 0; o < l; o++) ((p = (d = a[o]).parentNode === u) || G || z && !P) && (y = d.offsetTop, R && p && Math.abs(y - _) > L && ("BR" !== d.nodeName || 0 === o) && (h = [], R.push(h), _ = y), G && (d._x = d.offsetLeft, d._y = y, d._w = d.offsetWidth, d._h = d.offsetHeight), R && ((d._isSplit && p || !z && p || P && p || !P && d.parentNode.parentNode === u && !d.parentNode._isSplit) && (h.push(d), d._x -= S, C(d, u, k) && (d._wordEnd = !0)), "BR" === d.nodeName && (d.nextSibling && "BR" === d.nextSibling.nodeName || 0 === o) && R.push([])));
        for (o = 0; o < l; o++) if (p = (d = a[o]).parentNode === u, "BR" !== d.nodeName) if (G && (c = d.style, P || p || (d._x += d.parentNode._x, d._y += d.parentNode._y), c.left = d._x + "px", c.top = d._y + "px", c.position = "absolute", c.display = "block", c.width = d._w + 1 + "px", c.height = d._h + "px"), !P && z) if (d._isSplit) for (d._next = r = d.nextSibling, d.parentNode.appendChild(d); r && 3 === r.nodeType && " " === r.textContent;) d._next = r.nextSibling, d.parentNode.appendChild(r), r = r.nextSibling; else d.parentNode._isSplit ? (d._parent = d.parentNode, !d.previousSibling && d.firstChild && (d.firstChild._isFirst = !0), d.nextSibling && " " === d.nextSibling.textContent && !d.nextSibling.nextSibling && J.push(d.nextSibling), d._next = d.nextSibling && d.nextSibling._isFirst ? null : d.nextSibling, d.parentNode.removeChild(d), a.splice(o--, 1), l--) : p || (y = !d.nextSibling && C(d.parentNode, u, k), d.parentNode._parent && d.parentNode._parent.appendChild(d), y && d.parentNode.appendChild(U.createTextNode(" ")), "span" === V && (d.style.display = "inline"), H.push(d)); else d.parentNode._isSplit && !d._isSplit && "" !== d.innerHTML ? O.push(d) : z && !d._isSplit && ("span" === V && (d.style.display = "inline"), H.push(d)); else R || G ? (d.parentNode && d.parentNode.removeChild(d), a.splice(o--, 1), l--) : P || u.appendChild(d);
        for (o = J.length; -1 < --o;) J[o].parentNode.removeChild(J[o]);
        if (R) {
            ...
            for (f = " " === k && (!G || !P && !z), o = 0; o < R.length; o++) {
                for (h = R[o], (g = U.createElement(V)).style.cssText = "display:block;text-align:" + W + ";position:" + (G ? "absolute;" : "relative;"), $ && (g.className = $ + (I ? o + 1 : "")), j.push(g), l = h.length, r = 0; r < l; r++) "BR" !== h[r].nodeName && (d = h[r], g.appendChild(d), f && d._wordEnd && g.appendChild(U.createTextNode(" ")), G && (0 === r && (g.style.top = d._y + "px", g.style.left = S + y + "px"), d.style.top = "0px", y && (d.style.left = d._x - y + "px")));
    ...
    function G(D, u, e, t) {
        ...
        var F, i, n, C, s, E, o, r, l = u.tag ? u.tag : u.span ? "span" : "div",
            d = ~(u.type || u.split || "chars,words,lines").indexOf("chars"), a = w(u), p = u.wordDelimiter || " ",
            h = " " !== p ? "" : a ? "&#173; " : " ", f = "</" + l + ">", B = 1,
            c = u.specialChars ? "function" == typeof u.specialChars ? u.specialChars : x : null,
            g = U.createElement("div"), y = D.parentNode;
        for (y.insertBefore(g, D), g.textContent = D.nodeValue, y.removeChild(D), o = -1 !== (F = function getText(D) {
            var u = D.nodeType, e = "";
            if (1 === u || 9 === u || 11 === u) {
            ...
            return e
        }(D = g)).indexOf("<"), !1 !== u.reduceWhiteSpace && (F = F.replace(_, " ").replace(S, "")), o && (F = F.split("<").join("{{LT}}")), s = F.length, i = (" " === F.charAt(0) ? h : "") + e(), n = 0; n < s; n++) if (E = F.charAt(n), c && (r = c(F.substr(n), u.specialChars))) E = F.substr(n, r || 1), i += d && " " !== E ? t() + E + "</" + l + ">" : E, n += r - 1; else if (sb(E) && !sb(F.charAt(n - 1)) && n) {
        ...
        D.outerHTML = i + (B ? f : ""), o && A(y, "{{LT}}", "<")
    }

    function H(D, u, e, t) {
        var F, i, n = o(D.childNodes), C = n.length, s = w(u);
        if (3 !== D.nodeType || 1 < C) {
    ...
    var U, e, t, i, s, o, r, S = /(?:\r|\n|\t\t)/g, _ = /(?:\s\s+)/g, m = String.fromCharCode(160), l = "SplitText",
        d = q(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), a = q(103, 115, 97, 112, 46, 99, 111, 109),
        p = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, h = function (D) {
            var u = "undefined" != typeof window,
                e = true,
                // e = 0 === (u ? window.location.href : "").indexOf(q(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(q(108, 111, 99, 97, 108, 104, 111, 115, 116)) || p.test(D) || (u ? window.location.hostname : "").split(".").pop() === q(108, 111, 99, 97, 108),
    ...
    function SplitText(D, u) {
        t || n(), this.elements = o(D), this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = u || {}, s(this), h && this.split(u)
    }

    f.version = "3.12.5", f.register = n, u.SplitText = f, u.default = f;
